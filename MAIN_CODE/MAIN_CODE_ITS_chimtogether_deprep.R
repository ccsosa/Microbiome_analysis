...
marker="ITS2_chimechecktogether.derepmin.lotus2tax"
#Add directories
...
physeq <- readRDS("/data/pipeline/its2/101_sl-jgi_colombia25/chimechecktogether.derepmin.lotus2tax/ecm_physeq.Rdata")
