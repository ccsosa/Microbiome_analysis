...
#MAKE DIR
out_comparison_dir <- paste0(dir,"/","comp_ITS2_20250725_FILT")
...
paths <- c(
  ...
  "/data/pipeline/its2/101_sl-jgi_colombia25/chimechecktogether.derepmin.withdiscardsmapped.lotus2tax/ecm_physeq.Rdata"
)
